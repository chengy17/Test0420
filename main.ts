...
namespace LEDBit {
    ...
    let manStop1: number[] = [0x00,0xC0,0x03,0x40,0x02,0x40,0x02,0xC0,0x03,0xA0,0x05,0x90,0x09,0x40,0x02,0x20,0x04];
    let manStop2: number[] = [0x00,0xE0,0x07,0x20,0x04,0x20,0x04,0x20,0x04,0xE0,0x07,0xC0,0x03,0xA0,0x05,0xA0,0x05];
